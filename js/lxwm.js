    ...
    myAddEvent(document,'scroll',function(){
        ...
        for (var index = 0; index < elements.length; index++) {
            ...
            if(elTop*1.5<=clientHeight){
                el.className = 'parter-content-1 col-md-3 col-sm-6 col-xs-12 animated '+animate; 
                el.style['animation-delay']=n +"ms";
            }else{
                el.className = 'parter-content-1 col-md-3 col-sm-6 col-xs-12';
            }
...
myAddEvent(window,'load',function(){
    ...
    // }
    // // 执行可视区函数
    visibleAnimate(document.getElementsByClassName('parter-content-1'))
})